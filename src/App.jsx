...
//   useEffect(() => {
//     axios.get('https://backend-ai-planet.vercel.app/home')
//       .then((res) => {
//         setPage(res.data);
//       })
//       .catch((err) => {
...
//     try {
//       setIsLoading(true);
//       const result = await axios.post('https://backend-ai-planet.vercel.app/home', formData, {
//         headers: { "Content-Type": "multipart/form-data" }
//       });
//       console.log('File uploaded successfully', result.data);
//       setExtractedText(result.data.extractedText);
...
//       const result = await axios.post('https://backend-ai-planet.vercel.app/query', { text: extractedText, questions: questionsArray });
//       const responses = result.data.responses.map(resp => resp.answer).join('\n');
